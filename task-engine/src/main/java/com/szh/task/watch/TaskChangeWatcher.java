...
public class TaskChangeWatcher {
    ...
    public static boolean registerWatcher(File file){
        try {
            ...
            FileAlterationObserver observer = new FileAlterationObserver(file, FileFilterUtils.and(FileFilterUtils.fileFileFilter()));
    ...
    static class TaskChangeListener extends FileAlterationListenerAdaptor{
