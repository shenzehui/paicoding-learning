package com.szh.datasourceinitializer.config;

import com.szh.datasourceinitializer.util.SpringUtil;
...
public class DataSourceInit {
    ...
    public DataSourceInitializer dataSourceInitializer(final DataSource dataSource) {
        ...
        // true 表示执行，false 表示不需要初始化
        initializer.setEnabled(needInit(dataSource));
        return initializer;
    }

    /**
     * 检查一下数据库表是否存在，若存在则不初始化，否则基于 init-schema.sql 进行初始化
     *
     * @param dataSource
     * @return
     */
    ...
    private DatabasePopulator databasePopulator() {
        ...
        populator.addScripts(schemaSql, initData);
